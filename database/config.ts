...
export const validation = {
  ...
  templateStatuses: ["active", "inactive", "draft"] as const,

  imageFormats: ["png", "jpg", "jpeg", "webp"] as const,

  placeholderTypes: ["text", "image"] as const,

  userRoles: ["admin", "user", "moderator"] as const,
};
